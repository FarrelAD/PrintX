...
export default function OGGenerator() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-8" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      >
        ...
        >
          <div className="flex items-center gap-6 mb-8">
            <svg width="80" height="80" viewBox="0 -960 960 960" fill="currentColor">
            ...
            <h1 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '120px', lineHeight: '1', margin: 0, textTransform: 'uppercase' }}>PRINTX</h1>
          </div>
          
          <p style={{ color: '#4b5563', fontSize: '30px', marginBottom: '48px', maxWidth: '700px', lineHeight: '1.3', fontWeight: 500 }}>
            Ubah Spreadsheet Anda Menjadi Dokumen Siap Cetak
          </p>
          
          <div className="flex gap-6">
            <div style={{ backgroundColor: 'black', color: 'white', padding: '16px 32px', fontSize: '20px', fontWeight: 'bold', border: '2px solid black', textTransform: 'uppercase', letterSpacing: '0.1em' }}>
              Cetak Massal
            </div>
            <div className="flex items-center gap-3" style={{ backgroundColor: 'white', color: 'black', padding: '16px 32px', fontSize: '20px', fontWeight: 'bold', border: '2px solid black', textTransform: 'uppercase', letterSpacing: '0.1em' }}>
