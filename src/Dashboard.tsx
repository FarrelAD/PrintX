    ...
    <div className="flex min-h-screen bg-background text-on-background">
      ...
      <aside className="hidden lg:flex w-[280px] bg-white border-r border-primary flex-col sticky top-0 h-screen z-10">
        ...
        <nav className="flex-1 py-6 flex flex-col">
          <a href="#" className="flex items-center gap-4 py-4 px-8 uppercase text-sm font-semibold tracking-wider text-primary bg-surface-container-high border-l-4 border-primary transition-all">
      ...
      <main className="flex-1 flex flex-col pb-20 lg:pb-0">
        <header className="p-12 md:p-margin bg-white border-b border-primary">
          ...
          <div className="flex justify-between items-center gap-6 max-md:flex-col max-md:items-start">
            <h1 className="text-[clamp(24px,5vw,32px)] font-heading font-medium">Dashboard Proyek</h1>
            <button className="bg-primary text-on-primary py-3 px-6 font-semibold tracking-widest uppercase text-sm border border-primary hover:bg-on-primary hover:text-primary active:scale-95 transition-all flex items-center gap-2 max-md:w-full max-md:justify-center">
