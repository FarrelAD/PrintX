        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "PrintX adalah aplikasi web PWA lokal untuk mencetak dokumen massal seperti kartu ID, sertifikat, dan label secara otomatis dari spreadsheet. 100% aman dan berjalan offline.",
              "offers": {
                "@type": "Offer",
                "price": "0.00",
                "priceCurrency": "USD"
